                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-center justify-center max-w-[250px] text-center">
                        ...
                        <span className="mt-4 text-neutral-200 text-sm">
                            Made by <Link href="https://shreyas-sihasane.vercel.app/" className="font-semibold ml-1">Muhammed</Link>
                        </span>
                        <p className="text-sm text-muted-foreground mt-4">
                            &copy; {new Date().getFullYear()} Valysis INC. All rights reserved.
                        </p>
                    </div>
                </AnimationContainer>

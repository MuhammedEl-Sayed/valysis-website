		...
		<MaxWidthWrapper className='max-w-3xl mx-auto px-8 mb-40'>
			<AnimationContainer delay={0.1} className='w-full'>
				...
				<ul className='list-disc ml-8 mt-4 text-muted-foreground'>
					...
					<li>
						<strong>Service</strong> refers to the Valysis mobile application.
					</li>
					<li>
						<strong>Service Provider</strong> means third parties that help us
						operate, maintain, or analyze the Service.
					</li>
					<li>
					...
					<li>
						...
						(or similar tracking technologies used in-app).
					</li>
					<li>
				...
				<p className='mt-4 text-muted-foreground'>
					We may ask for information like email addresses or Riot account
					details. We primarily collect:
				</p>
				<ul className='list-disc ml-8 text-muted-foreground mt-2'>
					<li>Email address (if you provide it)</li>
					<li>Account identifiers (e.g., Riot ID)</li>
					<li>Cookies</li>
					<li>Usage Data</li>
				</ul>
				...
				<p className='mt-4 text-muted-foreground'>
					This includes your device’s IP address, device type, OS version, app
					version, time spent in-app, crash logs, and other diagnostic data.
				</p>

				<h3 className='text-lg mt-8'>Cookies & Tracking</h3>
				<p className='mt-4 text-muted-foreground'>
					We use cookies and in-app tracking technologies (like SDKs) to operate
					and personalize the Service. You can disable tracking in your device
					or browser settings, but some features may stop working properly.
				</p>
				...
				<ul className='list-disc ml-8 text-muted-foreground mt-2'>
					...
					<li>Analyze and understand usage patterns</li>
				...
				<ul className='list-disc ml-8 text-muted-foreground mt-2'>
					...
					<li>Right to opt out of data selling (we don’t sell your data)</li>
				</ul>
